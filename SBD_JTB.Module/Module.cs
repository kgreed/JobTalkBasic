...
namespace SBD_JTB.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class SBD_JTBModule : ModuleBase {
        static SBD_JTBModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<SBD_JTBDbContext>());
            // #endif 
        }
        public SBD_JTBModule() {
            InitializeComponent();
        }
